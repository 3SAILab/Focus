/**
 * HistoryPendingItem Component
 * 待处理任务渲染组件
 * Requirements: 2.5
 */

import type { PendingTask } from '../../hooks/useGroupedHistory';
import ImageGrid from '../ImageGrid';

export interface HistoryPendingItemProps {
  task: PendingTask;
}

export function HistoryPendingItem({ task }: HistoryPendingItemProps) {
  return (
